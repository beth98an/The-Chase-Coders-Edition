  ...
  return (
    ...
    <div className='home'>
      ...
      <div className='rules'>
        ...
        <p>The rules for this game are simple, have fun! You need a max of 4 players to play alongside you, but you can however play alone if you dare to. This quiz consists of several categories which you can choose from yourself, along with the level of difficulty and players. You score is tracked across each question and will be displayed for you at the end. Make sure to get your answers right so you can top our leaderboard!</p>
      </div>
      {/* <Timer/> */}
